...
test_cleaned = clean_up(test_string)
...
token_test = tokenize(test_cleaned)
...
def stem_and_lemmatize(l):
    ...
    ps = PorterStemmer()
    lemmatizer = WordNetLemmatizer()
    return [lemmatizer.lemmatize(ps.stem(el)) for el in l]


# In[24]:


stem_and_lemmatize(token_test)
...
list_test = stem_and_lemmatize(token_test)
remove_stopwords(list_test)
